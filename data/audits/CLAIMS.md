...
|---|---|---|---|
| 2026-08-17 | Sim account balance is $3,000 — hardcoded SIM_ACCOUNT_BALANCE, NOT the ACCOUNT_BALANCE env (which is a LIVE-only fallback) | `grep -oE 'SIM_ACCOUNT_BALANCE +=  *[0-9.]+' marcos_trading_bot.py {PIPE} head -1 {PIPE} tr -s ' '` | `SIM_ACCOUNT_BALANCE = 3000.0` |
