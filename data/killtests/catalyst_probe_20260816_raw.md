# CATALYST PROBE 8/16 — Alpaca News REST (v1beta1/news), read-only
run at 2026-08-16T11:33:16 local

## Probe 1a — access check: XHG,DFSC,MF,WETO,LBGJ 8/13-8/14
HTTP 200 on our plan; 14 articles; fields: author, content, created_at, headline, id, images, source, summary, symbols, updated_at, url
...
## Probe 1b — coverage census: top-12 by gain, last 10 manifest dates 2026-08-03..2026-08-14
window per name-day = (prior business day 20:00Z, day 20:00Z]; 'pre-open' = created_at < 13:30Z (09:30 ET)
...
## Probe 2 — point-in-time catalyst kill-test, 36 dates 2026-06-25..2026-08-14, LIVE-parity chain (15:45 flatten, 15:30 cutoff, E3)
reconcile vs flatten_parity NEW: O-config H4 N=154 total $+5643.21; BA solo N=384; grinder solo N=231
name-days needing news: 317
rate-limit after probe 2 fetch: 350 requests, 0 x 429; headers: {'X-Ratelimit-Limit': '10000', 'X-Ratelimit-Remaining': '9999', 'X-Ratelimit-Reset': '1786894584'}
