...
def main():
    ...
    ARMS = {
        "A_floor15  (CONTROL)": lambda r: r["gain"] >= 15.0,
        "A_floor5":             lambda r: r["gain"] >= 5.0,
        "A_nofloor":            lambda r: True,
        "A_relvol2":            lambda r: r["relvol"] >= 2.0,
        "A_relvol3":            lambda r: r["relvol"] >= 3.0,
    }
    ho = set(dates[44:])
