...
check("P3 ALL consumers via choke-point (zf + reclaim/hidden + ignition-10s + dip-rip 7/30); one direct read left = inside _curl_feed itself",
      SRC.count("_curl_feed(t)") == 4
