...
check("W3 chart-gate bypass", bot._chart_break_gate("ZZZZ", 9.99, "hidden_entry")[0] == "allow")
...
check("W11 conversion RTH-floored 09:30", '_he_fire and HIDDEN_ENTRY and _hm_curl >= "09:30"' in BOT)
