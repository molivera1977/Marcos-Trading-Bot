...
check("W18 premarket cap small (default 2)", bot.PRE_MAX_TRADES == 2)
check("W19 premkt gate v2 shadows legacy lanes", "lane_not_premkt" in BOT and "premkt_capped" in BOT)
